          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-12">
            <div className="space-y-8">
              {[
                ...
                { icon: MapPin, title: 'Flagship Boutique', body: 'Auverra Maison, Kala Ghoda, Mumbai 400001', sub: 'By appointment' },
                ...
                <div key={i} className="flex gap-4 group">
                  ...
                  <div>
                    ...
                    <div className="font-serif text-lg text-platinum-light">{c.body}</div>
